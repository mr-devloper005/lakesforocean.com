  ...
  return (
    <form className="mt-6 grid gap-4" onSubmit={onSubmit}>
      <div className="grid gap-2">
        <Label htmlFor="login-email" className="text-xs font-semibold uppercase tracking-[0.16em] text-neutral-500">
          Email
        </Label>
        <Input
          id="login-email"
      ...
      <div className="grid gap-2">
        <Label htmlFor="login-password" className="text-xs font-semibold uppercase tracking-[0.16em] text-neutral-500">
          Password
        </Label>
        <Input
          id="login-password"
      ...
      <p className={`text-xs ${mutedClassName}`}>Your session is stored locally in the browser for this demo.</p>
    </form>
  )
}
